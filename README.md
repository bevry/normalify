...
``` typescript
import pkg from 'https://unpkg.com/normalify@^2.27.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/normalify@^2.27.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/normalify@^2.27.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/normalify@2.27.0'
</script>
```
